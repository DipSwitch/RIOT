...
/**
 * @ingroup     boards_stm32f334-disco
 * @{
 *
 * @file
 * @brief       Peripheral MCU configuration for the STM32F334-DISCO board
 *
 ...
 * @{
 */
#define CLOCK_HSE_BP        (8000000U)          /* external oscillator */
#define CLOCK_CORECLOCK     (72000000U)         /* desired core clock frequency */

/* the actual PLL values are automatically generated */
#define CLOCK_PLL_MUL       (CLOCK_CORECLOCK / CLOCK_HSE_BP)
